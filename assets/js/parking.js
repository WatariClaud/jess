...
function find_parking() {
    ...
    var apiUrl = 'http://4c97-105-160-43-36.ngrok.io/jess/api/parking/find_available.php';
    ...
    setTimeout(() => {
        for(var i = 0; i < buttons.length; i ++) {
            ...
            buttons[i].onclick = function(e) {
                ...
                var apiUrl = 'http://4c97-105-160-43-36.ngrok.io/jess/api/parking/book_space.php?id='+spot_id;
