...
function find_tickets() {
    ...
    var apiUrl = 'http://4c97-105-160-43-36.ngrok.io/jess/api/tickets/user_tickets.php';
    ...
    setTimeout(() => {
        for(var i = 0; i < buttons.length; i ++) {
            ...
            buttons[i].onclick = function(e) {
                ...
                var apiUrl = 'http://4c97-105-160-43-36.ngrok.io/jess/api/tickets/pay_ticket.php?id='+ticket_id;
